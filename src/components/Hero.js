        ...
        <div className="hero-content">
          <div className="hero-left">
            ...
            <div className="hero-social">
              ...
              <a href="https://www.linkedin.com/in/shriya-tanwar-003030182" target="_blank" rel="noopener noreferrer" className="social-icon linkedin-icon" aria-label="LinkedIn">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
